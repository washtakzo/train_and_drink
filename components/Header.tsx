      ...
      >
        <div className={`grid grid-cols-3 items-center `}>
          ...
          <Typography
            variant="h5"
            component="h1"
            className="py-6 px-4 font-bold cursor-pointer text-lg sm:text-2xl"
            fontWeight={"bold"}
          ...
          {/* midle */}
          <div
            className={`w-[100%] max-w-lg m-auto ${
              isHeaderTransparent
                ? "text-white bg-white-200 border-solidborder-2rounded-lg"
                : "borderTheme "
            }${transition}`}
          >
            <TextField
              variant="standard"
              color="secondary"
              placeholder={placeholder ? placeholder : "Search a home gym"}
              inputProps={{
